 ...
 */
class Tx_QmConfiguration_Utility_LocalConfiguration implements t3lib_Singleton
{
    ...
    /**
     * Parse localconfiguration and return it as array
     *
     * @param string $extensionKey
     * @return array localconfiguration configuration
     */
    protected function parseConfiguration($extensionKey)
    {
        $configuration = $GLOBALS['TYPO3_CONF_VARS']['EXTCONF'][$extensionKey];

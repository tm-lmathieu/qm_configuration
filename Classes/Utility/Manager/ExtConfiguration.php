 ...
 */
class Tx_QmConfiguration_Utility_Manager_ExtConfiguration
{
    ...
    public static function initialize()
    {
        ...
        return $objectManager->get('Tx_QmConfiguration_Utility_ExtConfiguration');
    }
     ...
     * @return array ext configuration
     * @static
     */
